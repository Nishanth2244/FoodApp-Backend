...
public class MenuCategoryController {
	...
	public ResponseEntity<MenuCategory> addCategory(@RequestParam(value = "name") String name,
													@RequestParam(value = "imageFile") MultipartFile imageFile){
		MenuCategory menu = menuCategoryService.addNewCategory(name, imageFile);
	...
	public MenuCategory updateCategory(@PathVariable long id,
		...
		return menuCategoryService.updateCat(id, name, imageFile);
	}
